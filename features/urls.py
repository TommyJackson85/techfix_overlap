...
from .views import get_feature_posts, search_feature_posts, feature_post_detail, create_or_edit_featurepost
...
urlpatterns = [
    ...
    url(r'^search/$', search_feature_posts, name='search_feature_posts'),
